...
const TALENT: TalentCard[] = [
  {
    ...
    initials: "AM",
    role: "Brand Designer",
    region: "India · US overlap",
    tools: ["Figma", "Illustrator", "Photoshop"],
    photo: "/talent/in-01.jpg",
  ...
  },
  {
    ...
    region: "India · EU overlap",
    tools: ["Zapier", "Make", "n8n"],
    photo: "/talent/in-04.jpg",
  ...
  },
  {
    ...
    initials: "PN",
    role: "Art Director",
    region: "India · Flex hours",
    tools: ["Figma", "Adobe CC"],
    photo: "/talent/in-05.jpg",
  ...
  },
  {
    ...
    region: "India · UK overlap",
    tools: ["React", "Next.js", "Tailwind"],
    photo: "/talent/in-02.jpg",
